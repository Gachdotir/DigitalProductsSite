...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = models.BigIntegerField(_('phone number'), unique=True, null=True, blank=False,
                                          validators=[
    ...
    def get_full_name(self):
        full_name = '%s %s' % (self.frist_name, self.last_name)
...
class UserProfile(models.Model):
    ...
    gender = models.BooleanField(_('gender'), help_text=_('female: 0, male: 1, null: unset'), null=True, blank=True)
    province = models.ForeignKey(verbose_name=_('province'), to= 'Province', on_delete=models.SET_NULL, null=True)
